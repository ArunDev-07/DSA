...
// if end < arr.length return the arr[end] . in this we find the floor element that means biggest element smaller than the target so we print the end same as the ceiling because we need to find the biggest element smaller than the target. all depands on the while loop .
